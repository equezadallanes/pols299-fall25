...
1. Introduction (establish what you are doing, the research question, and main findings and conclusions)
2. Literature review (why is it important to study congregational life, what has previous work found)
...
4. The congregation you are visiting and its religious tradition (provide some background on the congregation and its religious tradition - [use data](https://www.pewresearch.org/religion/religious-landscape-study/)
	- Clearly state what you expect to see and justify it.
	- Write one or two explicit hypotheses.
6. Results (describe what you found during the service)
7. Discussion (do your results match your initial expectations? if not, why do you think they didn't)
